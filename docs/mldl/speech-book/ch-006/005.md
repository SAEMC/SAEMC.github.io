...
!!! note "**그림1** CTC INPUT"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** CTC PREDICTION"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림3** ALL POSSIBLE PATHS"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/003.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** ALL POSSIBLE PATHS"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/004.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** CONDITIONAL INDEPENDENCE"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/005.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림6** FORWARD COMPUTATION EXAMPLE"
    ...
    ![006](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/006.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림7** CASE 1"
    ...
    ![007](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/007.png?raw=true){ load=lazy width=100% }

<br/>

!!! note "**그림8** CASE 2"

    ![008](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/008.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림9** FORWARD FLOW"
    ...
    ![009](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/009.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림10** BACKWARD COMPUTATION EXAMPLE"
    ...
    ![010](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/010.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림11** COMPLETE PATH CALCULATION EXAMPLE"
    ...
    ![011](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/011.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림12** LIKELIHOOD COMPUTATION EXAMPLE"
    ...
    ![012](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/012.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림13** GRADIENT COMPUTATION EXAMPLE (1)"
    ...
    ![013](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/013.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림14** GRADIENT COMPUTATION EXAMPLE (2)"
    ...
    ![014](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/014.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림15** BEST PATH DECODING"
    ...
    ![015](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/015.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림16** PREFIX DECODING"
    ...
    ![016](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/016.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림17** BEAM SEARCH (1)"
    ...
    ![017](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/017.png?raw=true){ load=lazy width=100% }

<br/>

!!! note "**그림18** BEAM SEARCH (2)"

    ![018](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/018.png?raw=true){ load=lazy width=100% }

<br/>

!!! note "**그림19** BEAM SEARCH (3)"

    ![019](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/019.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림20** ACTIVATIONS"
    ...
    ![020](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/005/020.png?raw=true){ load=lazy width=100% }
