...
!!! note "**그림1** LISTEN, ATTEND AND SPELL"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/002/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** PYRAMID BIDIRECTIONAL LSTM"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/002/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**표1** LISTEN, ATTEND AND SPELL"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/002/003.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** LISTEN, ATTEND AND SPELL"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/002/004.png?raw=true){ load=lazy width=100% }
