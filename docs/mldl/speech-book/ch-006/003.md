...
!!! note "**그림1** DEEP SPEECH2"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** TIME DOMAIN CONVOLUTION"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/002.png?raw=true){ load=lazy width=100% }
...
지금까지 예시로 설명한 것은 시간 축에 대한 컨볼루션 연산(1d conv)이었다. **그림3**에서 녹색 칸과 같다. $t^{\prime}$번째에서 $t^{\prime \prime}$번째 프레임(시간대)의 정보(**time-only domain**)를 취한다. 이 때 계산 대상 주파수 영역대는 $d$개 bin 전체가 된다.

<br/>

!!! note "**그림3** 1D CONV VS. 2D CONV"

    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/003.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** BIDIRECTIONAL RNN"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/004.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** BIDIRECTIONAL RNN"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/005.png?raw=true){ load=lazy width=100% }
...
!!! note "**표1** RNN 깊이, 히든 차원수에 따른 성능 차이"
    ...
    ![006](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/006.png?raw=true){ load=lazy width=100% }
...
!!! note "**표2** 컨볼루션 설정별 성능 차이"
    ...
    ![007](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/007.png?raw=true){ load=lazy width=100% }
...
!!! note "**표3** SORTAGRAD 효과"
    ...
    ![008](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-006/003/008.png?raw=true){ load=lazy width=100% }
