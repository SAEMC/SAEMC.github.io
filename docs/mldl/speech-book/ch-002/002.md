...
!!! note "**그림1** SIMPLE WAVE"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** SPEECH SOUND WAVE"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림3** ORIGINAL SIGNAL"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/003.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** SAMPLING"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/004.png?raw=true){ load=lazy width=100% }
...
!!! note "Anti-Aliasing"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/005.png?raw=true){ load=lazy width=100% }
    ...
    ![006](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/006.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** QUANTIZATION"
    ...
    ![007](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/007.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림6** QUANTIZATION 효과"
    ...
    ![008](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/008.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림7** LOUDNESS와 POWER"
    ...
    ![009](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/009.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림8** "SHE JUST HAD A BABY" 문장의 WAVEFORM"
    ...
    ![010](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/010.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림9** 음절 구조"
    ...
    ![011](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/011.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림10** 모음 IY의 스펙트럼과 포만트"
    ...
    ![012](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/012.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림11** 서로 다른 모음의 스펙트로그램"
    ...
    ![013](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/013.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림12** 기본 주파수와 배음"
    ...
    ![014](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/014.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림13** THE SOURCE-FILTER MODEL (1)"
    ...
    ![015](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/015.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림14** THE SOURCE-FILTER MODEL (2)"
    ...
    ![016](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-002/002/016.png?raw=true){ load=lazy width=100% }
