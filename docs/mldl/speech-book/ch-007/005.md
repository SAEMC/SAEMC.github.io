...
!!! note "**그림1** MOTIVATION"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** COMPOSITION"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/002.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림3** DETERMINIZATION"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/003.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** MINIMIZATION"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/004.png?raw=true){ load=lazy width=100% }
...
!!! note "**표1** TRANSDUCERS"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/005.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** CONCEPT (1)"
    ...
    ![006](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/006.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림6** CONCEPT (2)"
    ...
    ![007](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/007.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림7** GRAMMAR TRANSDUCER"
    ...
    ![008](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/008.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림8** LEXICON TRANSDUCER"
    ...
    ![009](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/009.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림9** L ◦ G COMPOSITION"
    ...
    ![010](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/010.jpg?raw=true){ load=lazy width=100% }
...
!!! note "**그림10** CONTEXT-DEPENDENT TRANSDUCER"
    ...
    ![011](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/011.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림11** HMM TRANSDUCER"
    ...
    ![012](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/005/012.jpg?raw=true){ load=lazy width=100% }
