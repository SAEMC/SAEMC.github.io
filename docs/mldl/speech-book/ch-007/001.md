...
!!! note "**그림1** HMM 기반 모델 디코딩"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/001/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** WER 계산 예시"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/001/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림3** MAPSSWE 계산 예시"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-007/001/003.png?raw=true){ load=lazy width=100% }
