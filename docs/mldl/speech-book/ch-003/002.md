...
!!! note "**그림1** FOURIER TRANSFORM"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/002/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** EULER'S FORMULA"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/002/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림3** 복소 지수 함수"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/002/003.gif?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** FOURIER TRANSFORM 개념도"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/002/004.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** FOURIER TRANSFORM"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/002/005.png?raw=true){ load=lazy width=100% }
