...
!!! note "**그림1** FRAMEWORK"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/003/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** HAMMING WINDOW"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/003/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림3** RECTANGULAR WINDOW VS HAMMING WINDOW"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/003/003.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** DISCRETE FOURIER TRANSFORM"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/003/004.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** MAGNITUDE와 PHASE"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/003/005.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림6** MEL SCALE FILTERS"
    ...
    ![006](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-003/003/006.png?raw=true){ load=lazy width=100% }
