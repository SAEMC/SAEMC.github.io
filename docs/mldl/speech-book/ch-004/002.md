...
!!! note "**그림1** HIDDEN MARKOV MODEL"
    ...
    ![001](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/001.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림2** 날씨가 [HOT, HOT, COLD]일 때 아이스크림 개수 [3, 1, 3]이 관측될 LIKELIHOOD"
    ...
    ![002](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/002.png?raw=true){ load=lazy width=100% }
...
!!! note "**표1** LIKELIHOOD (NAIVE)"
    ...
    ![003](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/003.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림4** FORWARD ALGORITHM"
    ...
    ![004](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/004.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림5** FORWARD COMPUTATION"
    ...
    ![005](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/005.png?raw=true){ load=lazy width=100% }

<br/>

!!! note "**그림6** FORWARD COMPUTATION"

    ![006](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/006.png?raw=true){ load=lazy width=100% }
...
!!! note "**표2** LIKELIHOOD (FORWARD AND BACKWARD)"
    ...
    ![007](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/007.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림8** VITERBI DECODING"
    ...
    ![008](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/008.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림9** VITERBI PROBABILITY"
    ...
    ![009](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/009.png?raw=true){ load=lazy width=100% }

<br/>

!!! note "**그림10** VITERBI PROBABILITY"

    ![010](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/010.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림8** VITERBI BACKTRACE"
    ...
    ![011](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/011.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림11** VITERBI DECODING"
    ...
    ![012](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/012.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림12** VITERBI DECODING"
    ...
    ![013](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/013.png?raw=true){ load=lazy width=100% }
...
!!! note "**그림13** EM ALGORITHM"
    ...
    ![014](https://github.com/SAEMC/Images-MLDL/blob/main/speech-book/ch-004/002/014.png?raw=true){ load=lazy width=100% }
