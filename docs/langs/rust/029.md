...
_From_ is a very convenient trait to use, and you know this because you have seen it so much already. With _From_ you can make a `String` from a `&str`, but you can make many types from many other types. For example, Vec uses _From_ for the following:
