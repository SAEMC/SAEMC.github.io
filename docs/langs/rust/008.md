...
Or maybe for some reason you _really_ need a function to have a name like `return`. Then you can write this:
...
For a `char` this is called a _byte_, and for a `&str` it's called a _byte string_.
